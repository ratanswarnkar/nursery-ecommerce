...
<head>
    ...
    <title>Admin Portal Login - Nursery E-Commerce</title>
    <style>
        ...
        button { width: 100%; padding: 0.75rem; background: #0284c7; color: white; border: none; border-radius: 0.375rem; font-weight: 600; cursor: pointer; transition: background 0.2s; }
...
<body>
    <div class="card">
        <h1>Admin Portal</h1>
        <p class="subtitle">Secure Administrative Authentication</p>
