        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-bold text-white">Live Plant Guarantee</h4>
                        <p class="text-xs text-slate-400 mt-1">Direct from greenhouse with transit-safe root hydration packaging.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-bold text-white">Expert Plant Care</h4>
                        <p class="text-xs text-slate-400 mt-1">Detailed sunlight, watering, and soil guidance included with every plant.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h4 class="text-sm font-bold text-white">Eco-Friendly Nursery</h4>
                        <p class="text-xs text-slate-400 mt-1">Biodegradable pots, organic manure, and zero toxic chemical fertilizers.</p>
                    </div>
                </div>
            </div>
        </div>
